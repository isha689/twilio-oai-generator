...
namespace Twilio.Rest.Api.V2010
{
    public class AccountResource : Resource
    {
        ...
        private static Request BuildDeleteRequest(DeleteAccountOptions options, ITwilioRestClient client)
        {
            ...
            string PathSid = options.PathSid ?? client.PathSid;
            path = path.replace("{"+"PathSid"+"}", PathSid);
        ...
        public static book Delete(DeleteAccountOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        public static AccountResource Update(
                                          TestResource.StatusEnum status,
                                          string pathSid = null,

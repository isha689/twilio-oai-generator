...
namespace Twilio.Rest.Api.V2010.Account
{
    public class CallResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateCallOptions options, ITwilioRestClient client)
        {
            ...
            string PathAccountSid = options.PathAccountSid ?? client.PathAccountSid;
            path = path.replace("{"+"PathAccountSid"+"}", PathAccountSid);
        ...
        private static Request BuildDeleteRequest(DeleteCallOptions options, ITwilioRestClient client)
        {
            ...
            string PathTestInteger = options.PathTestInteger;
            path = path.replace("{"+"PathTestInteger"+"}", PathTestInteger);
        ...
        public static book Delete(DeleteCallOptions options, ITwilioRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        public TestResource.StatusEnum TestEnum { get; private set; }
        ...
        public List<TestResource.StatusEnum> TestArrayOfEnum { get; private set; }
